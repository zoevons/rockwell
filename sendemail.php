...
<head>
    ...
    <title>Rockwell Jewellers</title>
    ...
    <link href="https://fonts.googleapis.com/css?family=Abril+Fatface|Lato:400,700&display=swap" rel="stylesheet">
          ...
          <div class="container">
            <div class="row align-items-center">
              ...
              <div class="col-12 order-1 col-sm-12 order-sm-1 col-md-4 order-md-2 col-lg-6">
                <div class="logo">
                  <a href="index-2.html"><img src="assets/images/new-logo1.png" alt="Logo" class="img-fluid"></a>
                </div>
              </div>
                          ...
                          <ul class="list-unstyled">
                            <li class="single-cart-item media">
                              ...
                              <div class="shopping-cart-title media-body">
                                <h4><a href="#">Serpenti Necklace</a></h4>
                                <p class="cart-price">£3,600</p>
                                </div>
                              ...
                              <li class="single-cart-item media">
                                ...
                                <div class="shopping-cart-title media-body">
                                  <h4><a href="#">Mikimoto Olive Ring</a></h4>
                                  <p class="cart-price">£2,380</p>
                                  </div>
                                  <div class="shopping-cart-delete">
                                    <a href="#"><i class="ion ion-md-close"></i></a>
                                  </div>
                    ...
                    <ul>
                      ...
                      <li class="mega" data-columns="4"><a href="shop-grid.html"><span>Shop</span></a>
                        <ul class="mega-container">
                          <li><a href="shop-grid.html" class="mega-menu-title"><h3>Shop</h3></a>
                            <ul>
                              <li><a href="necklaces.html">Necklaces</a></li>
                              <li><a href="rings.html">Rings</a></li>
                              <li><a href="earrings.html">Earrings</a></li>
                              <li><a href="bracelets.html">Bracelets</a></li>
                              <li><a href="brooches.html">Brooches</a></li>
                              <li><a href="necklaces.html">Pendants</a></li>
                              <li><a href="shop-grid.html">View All</a></li>
                            </ul>
                          </li>
                          <li><a href="#" class="mega-menu-title"><h3>Checkout</h3></a>
                            <ul>
                              <li><a href="cart.html">Shopping Cart</a><li>
                              <li><a href="checkout.html">Checkout Page</a></li>
                            </ul>
                          </li>
                          <li class="last"><a href="#" class="mega-menu-title"><h3>My Account</h3></a>
                            <ul>
                              <li><a href="my-account.html">My Account</a></li>
                              <li><a href="login.html">Login</a></li>
                              <li><a href="register.html">Register</a></li>
                      ...
                      <li><a href="lookbook.html"><span>Lookbook</span></a></li>
                                    ...
                                    <div class="feedback-socials mt-full">
                                        ...
                                        <div class="social-sharing d-flex align-items-center justify-content-center">
                                            <ul class="list-inline">
                                                ...
                                                <li class="list-inline-item"><a href="#" class="bg-instagram" data-toggle="tooltip" data-position="top" data-original-title="Instagram" target="_blank"><i class="fa fa-instagram"></i></a></li>
                                                <li class="list-inline-item"><a href="#" class="bg-linkedin" data-toggle="tooltip" data-position="top" data-original-title="LinkedIn" target="_blank"><i class="fa fa-linkedin"></i></a></li>
                                            </ul>
                                        </div>
                                    </div>
                                ...
                                <aside class="widget-container">
                                    <div class="widget-content">
                                        <div class="footer-logo mb-half">
                                            <h4 class="widgettitle">Rockwell Jewellers</h4>
                                        </div>
                                        <p>London based jewellers offering beautiful designer jewellery collections and bespoke creations since 1986.</p>
                                        <div class="footer-contact">
                                            <p><span>Address:</span>189 Newman Street, London, W1 2QP</p>
                                            <p><span>Phone:</span><a href="#">(0207) 804 7859</a></p>
                                            <p><span>Email:</span><a href="#">info@rockwelljewellers.com</a></p>
                                        </div>
                            ...
                            <div class="col-12 col-sm-12 col-md-6 order-md-4 col-lg-2 order-lg-3">
                                <aside class="widget-container">
                                    ...
                                    <div class="widget-content">
                                        <div class="widgetized-menu">
                                            <ul class="list-unstyled">
                                                <li><a href="faqs.html">Delivery Information</a></li>
                                ...
                                <aside class="widget-container">
                                    ...
                                    <div class="widget-content">
                                        <div class="newsletter-widget">
                                            <p>Subscribe to our newsletter to keep up to date with our latest news and special offers.</p>
                                        ...
                                        <div class="social-widget mt-half">
                                            <div class="socials d-flex align-items-center justify-content-center justify-content-md-start">
                                                <ul class="list-inline">
                                                    ...
                                                    <li class="list-inline-item"><a href="#" class="bg-linkedin" title="LinkedIn" target="_blank"><i class="fa fa-linkedin"></i></a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div> <!-- end of widget-content -->
                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-12 col-sm-12 col-md-6 col-lg-6">
                            <p class="copyright-text">© 2019 <a href="#" rel="nofollow">Rockwell Jewellers</a></p>
                        </div>
                        <div class="col-12 col-sm-12 col-md-6 col-lg-6">
